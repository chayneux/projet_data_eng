...
def merge_and_finalize():
    ...
    items = pd.read_csv(f"{transformed_dir}/transformed_items.csv")
    products = pd.read_csv(f"{transformed_dir}/transformed_products.csv")
    reviews = pd.read_csv(f"{clean_dir}/clean_reviews.csv")
